...
valor_est <- mean(resultado, na.rm = TRUE)
message("Implemtando um gerador com distribuição gamma(c,1), temos que o valor da integral é: ", valor_est)
